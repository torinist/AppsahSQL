...
alter table top_menu change URL MENUCONTENTS MEDIUMBLOB;
alter table top_menu add LASTUPMEMBER CHAR(10);
alter table top_menu add foreign key(LASTUPMEMBER) references member(id);
alter table top_menu add LASTUPDATE VARCHAR(32);
